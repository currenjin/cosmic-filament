...
![생각과 색인의 연결을 펼친 Cosmic Filament 화면](docs/images/cosmic-filament.png)

_생각과 색인의 연결을 그래프로 펼친 화면입니다._
...
`public/data/`와 `public/cards/`에는 공개용 **가상 데이터만** 둡니다. 실제 생각 원문과 색인 JSON, 인증 정보는 저장소에 넣지 않습니다.
